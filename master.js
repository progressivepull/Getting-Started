    ...
    let footer = `
            ...
            <div class="container">
                <ul class="list-unstyled d-flex social-network">
                    <li class="ms-3"><p  class=" footer-text text-center">2024 Progressive Pull, Inc &copy; </p></li>
                    ...
                    <li class="ms-3"><a class="link-dark" href="https://gab.com/progressivepull"><img class="website-social-network" src="lib/pull/dist/svg/gab.svg" alt="Mastodon" width="30" height="30" ></a></li>
                    <li class="ms-3"><a class="link-dark" href="https://discord.gg/HYFD6HgX"><img class="website-social-network" src="lib/pull/dist/svg/discord.svg" alt="Discord" width="30" height="30" ></a></li>
